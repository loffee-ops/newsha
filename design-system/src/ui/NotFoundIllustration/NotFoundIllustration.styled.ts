...
export const Text404Digit = styled.div`
...
export const AntennaShadow = styled.div`
    position: absolute;
...
export const ScreenOutInner = styled.div`
    width: 11em;
    height: 7.75em;
    display: flex;
    align-items: center;
...
export const G11 = styled(SpeakerDot)``;
export const G12 = styled(SpeakerDot)``;
export const G13 = styled(SpeakerDot)``;
